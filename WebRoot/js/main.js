 ...
 * 显示游戏操作说明
 */
function showPlayOper(){
	var client = getClientWidthAndHeight();
	var registerFrameLeft = (client.w-parseInt($('#form4').css('width')))/2;
	var registerFrameTop = 72;
	//设置表单框的位置
	setFrameLocation($('#form4'), registerFrameLeft, registerFrameTop);
}
/**
 * 显示主页面
 */
...
$(function (){
	...
	$('#form4 input[type="button"]').on('click', function(){
